class ServiceLineHeader:
    def __init__(self, dilimiter, lineIndex, procedureCode, billedAmount, units, serviceZip, diagPointers, serviceInterval, rangedService = False, repeatedService = False):
